...
public class BaseClass 
{
	...
	{
		//Loading Config.file 
		FileReader file=new FileReader("D:\\Eclips\\OpenCartApplication\\src\\test\\resources\\config.properties");
		p=new Properties();
		p.load(file);
		...
		if(p.getProperty("exicution_env").equalsIgnoreCase("remote"))
		{
			...
			driver=new RemoteWebDriver(new URL("http://local:4444/wd/hub"), capabilities);
		}
